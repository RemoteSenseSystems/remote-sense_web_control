...
const Videocall = (props: { session_name: string; JWT: string }) => {
  ...
  const [camIdList, setCamIdList] = useState<string[]>(["pty-portable-1_cam0","pty-portable-1_cam1","default_cam0", "default_cam1", "default_cam2", "default_cam3", "default_cam4", "default_cam5", "default_cam6", "default_cam7", "pty-lct-1_cam0", "pty-lct-1_cam1"]); //
